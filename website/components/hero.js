...
<div className="container lg:flex max-w-8xl mx-auto">
  ...
  <div className="w-full sm:p-8 lg:pt-20 lg:pb-40">
    ...
    <div className="mx-auto min-h-full lg:ml-0 flex flex-col gap-y-3">
